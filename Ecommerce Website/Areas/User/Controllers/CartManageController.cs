...
namespace Ecommerce_Website.Areas.User.Controllers
{
    public class CartManageController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(cartMasters.ToList());
        }

        public ActionResult ShowOrder()
        {
            var cartMasters = db.CartMasters.Include(c => c.ProductMaster).Include(c => c.UserMaster);
            return View(cartMasters.ToList().Where(x => x.refUserId == 3 && x.OrderProcess == true));
        }
